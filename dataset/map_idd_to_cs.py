...
# id to CS TrainID
id2csid         = { label.id      : label.csTrainId for label in labels      }

def transform_IDD_Segmentation_mask_to_CityScapes_Segmentation_mask(segmentation_mask):
    '''
    ...
    for i in id2csid.keys():
        transformed_mask[segmentation_mask == i] = id2csid[i]
